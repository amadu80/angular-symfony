...
namespace Flyers\FrontendBundle\Composer;
...
class ScriptHandler
{
     ...
     */
    public static function buildAngular(CommandEvent $event)
    {
...
namespace { return \$loader; }
    ...
    {
        $php = escapeshellarg(self::getPhp());
        $cmd = escapeshellarg(__DIR__.'/../Resources/bin/build_angular.php');
